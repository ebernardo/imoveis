...
{block name=title}Imoveis | Home{/block}
...
{block name=container}
	...
	<div class="container">
		...
		<div class="hero-unit">
			...
			Rodando com Phreeze {$PHREEZE_VERSION}{if ($PHREEZE_PHAR)} ({$PHREEZE_PHAR|basename}){/if}.</em></p>
		...
		<footer>
			<p>&copy; {$smarty.now|date_format:'%Y'} Imoveis</p>
		</footer>
